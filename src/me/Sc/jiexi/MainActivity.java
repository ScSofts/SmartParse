...
public class MainActivity extends Activity {
	...
	public static String forOpenString = "";
	private MouseView mouseView;
	public static com.tencent.smtt.sdk.WebView web;
	private boolean show = false;
	public static String front="javascript:if(typeof(a)==\"undefined\"&&typeof(xyplay)!=\"undefined\"){if(xyplay.video_front()==false){alert(\"已经第一集\");a=true}else{a=true;}}";
	public static String next="javascript:if(typeof(a)==\"undefined\"&&typeof(xyplay)!=\"undefined\"){if(xyplay.video_next()==false){alert(\"已经最后一集\");a=true}else{a=true;}}";
	...
	private void initWebView() {
		...
		if(lastUrlString ==""){
		web.loadUrl((forOpenString == "") ? "http://scvip.dowy.cn/so.php"
				: forOpenString);
		lastUrlString = web.getUrl();
		}else{
